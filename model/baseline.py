...
def eval():
    ...
    plt.savefig(f"{OUT_PATH}/baseline_confusion_matrix.png", dpi=300)
    plt.close()
    ...
    with open(f"{OUT_PATH}/baseline_model_results.json", "w") as file:
        file.write(json.dumps(results, indent=4))

    print(f"Results saved to {OUT_PATH}/baseline_model_results.json")
